...
impl InodeInfo {
    ...
    pub fn nlink(&self) -> u64 {
        match self {
            Self::Extended(extended) => extended.i_nlink as u64,
            Self::Compact(compact) => compact.i_nlink as u64,
        }
    }
    ...
    pub fn uid(&self) -> u32 {
        match self {
            Self::Extended(extended) => extended.i_uid,
            Self::Compact(compact) => compact.i_uid as u32,
        }
    }
    ...
    pub fn gid(&self) -> u32 {
        match self {
            Self::Extended(extended) => extended.i_gid,
            Self::Compact(compact) => compact.i_gid as u32,
        }
    }

    /// mode (full i_mode including file type bits)
    ...
    pub fn mtime(&self) -> u64 {
        match self {
            Self::Extended(extended) => extended.i_mtime,
            Self::Compact(_) => 0,
        }
    }
    ...
    pub fn mtime_nsec(&self) -> u32 {
        match self {
            Self::Extended(extended) => extended.i_mtime_nsec,
            Self::Compact(_) => 0,
        }
    }
}
